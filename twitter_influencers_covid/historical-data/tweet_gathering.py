# GO TO LINE 87 AND REPLACE THE AUTHENTICATOR TOKENS WITH YOUR PERSONAL KEYS
...
def get_tweets(account_list, auth_api):
	...
	if len(account_list) > 0:
		count, line_count, csv_count, tweet_count = 0, 0, 0, 0
...
def main():
	...
	auth = tweepy.OAuthHandler("<<API key here>>", "<<API secret key here>>")
	auth.set_access_token("<<Access token here>>","<<Access secret token here>>")
